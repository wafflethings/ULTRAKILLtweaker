...
namespace ULTRAKILLtweaker
{
    ...
    public class MainClass : UKMod
    {
        ...
        public IEnumerator WeirdgeFix()
        {
            ...
            SettingRegistry.settings.Add(new ArtifactSetting("ARTIFACT_nostamina", TweakerMenu.ChildByName("Modifiers").ChildByName("NoStamina"), false, true, "Lethargy", "V1 stayed up to 4AM on a school night and has no energy. No sliding, dash-jumps, or power-slams."));
            ...
            SettingRegistry.settings.Add(new ArtifactSetting("ARTIFACT_water", TweakerMenu.ChildByName("Modifiers").ChildByName("Water"), true, true, "Submerged", "Every level is flooded with water, how V1 works with all this water is beyond me."));
            SettingRegistry.settings.Add(new ArtifactSetting("ARTIFACT_gofast", TweakerMenu.ChildByName("Modifiers").ChildByName("GoFast"), true, true, "Late to Work", "V1 runs at 2 times the speed. Enemy speed is multiplied by 10 to keep up."));
